...
description: Creates well-structured, verifiable, low-hallucination prompts for any use case. Use when user says "genera un prompt", "crear un prompt", "quiero un prompt para...", "generate a prompt", "create a prompt", "I want a prompt for...", or asks for help structuring a prompt.
---
